...
const DrumController = ({ stop, name, power, volume, handleVolumeChange, changeSoundGroup }) => (
  <div className="controller">
    ...
    <input
      ...
      />
    <h2 id="display" >Instrument: {name}</h2>
    <button onClick={changeSoundGroup}>Change Instruments</button>
  </div>
);
